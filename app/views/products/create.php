    ...
    <div class="card">
        ...
        <form method="POST" action="<?= site_url('products/store') ?>">
            <div>
                ...
                <input type="text" name="product_name" maxlength="100" placeholder="Enter product name" required>
            </div>
            ...
            <div>
                ...
                <input type="number" name="quantity" min="0" step="1" placeholder="0" required>
            </div>
