...
<body>
    <div class="card">
        ...
        <form method="POST" action="<?= site_url('products/update/' . urlencode((string) $product['id'])) ?>">
            <div>
            ...
            <div>
                <label>Price</label>
                <input type="number" name="price" step="0.01" value="<?= htmlspecialchars((string) $product['price']); ?>" required>
            </div>
